...
import (
	...
	models "github.com/BNPrashanth/goexample-swagger/models"
)
...
func (o *PostTestOK) WithPayload(payload *models.Test) *PostTestOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post test o k response
func (o *PostTestOK) SetPayload(payload *models.Test) {
	o.Payload = payload
}
